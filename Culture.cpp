...
void Culture<T>::Display()
{
    ...
    int r;
    cout<<endl;
    cout<<"       Please Enter the ID of the attraction type >> ";
    cin >> r;
...
template <class T>
void Culture<T>::LastInformation()
{
    ...
    //Load Cultur information List List
    ///////////////////////////////////////////////////////////////////////
    LinkedList<T> info;
    string Cname3 , KeyWord3, KeyWordType3, orginalword3;
    
    ifstream theFile3;
    theFile3.open("CultureInformation.txt");
    if(theFile3.fail())
        cout<<"Can not"<<endl;
    ...
    ifstream theFile4;
    theFile4.open("CultureTypes.txt");
    if(theFile4.fail())
        cout<<"    "<<endl;
