...
template <class T>
void Sightseeing<T>::Display()
{
    
    
    //Load Sightseeing List
    /////////////////////////////////////////////////////////
...
template <class T>
void Sightseeing<T>::LastInformation()
{
    ...
    //Load Sightseeing Information List
    /////////////////////////////////////////////////////////
    ...
    ifstream theFile3;
    theFile3.open("SightseeingInformation.txt");
    if(theFile3.fail())
        cout<<"   "<<endl;
    ...
    ifstream theFile4;
    theFile4.open("SightseeingTypes.txt");
    if(theFile4.fail())
        cout<<"     "<<endl;
